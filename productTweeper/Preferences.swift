...
class Preferences : GenericManagerOfSettings {
    ...
    var colorOfBackgroundOfActivityIndicator            = GenericSetting<UIColor>   (key:"colorOfBackgroundOfActivityIndicator", first: UIColor(hue:0.58, brightness:0.5))

    var signalColor                                     = GenericSetting<UIColor>   (key:"signalColor", first: UIColor.white)
    var signalAlpha                                     = GenericSetting<CGFloat>   (key:"signalAlpha", first: 0.15)
    ...
    var signalDuration                                  = GenericSetting<Double>    (key:"signalDuration", first: 12.0)
    var signalThickness                                 = GenericSetting<CGFloat>   (key:"signalThickness", first: 30)
    
    var titleShadowColor                                = GenericSetting<UIColor>   (key:"titleShadowColor", first: UIColor.white)
    var titleShadowRadius                               = GenericSetting<CGFloat>   (key:"titleShadowRadius", first: 32.0)
