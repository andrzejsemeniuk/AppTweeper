...
class Data {
    ...
    static func add(entry:SearchEntry) {
        do {
    ...
    static func update(entry:SearchEntry, save:Bool = true) {
        let context = AppDelegate.instance.persistentContainer.viewContext
    ...
    static func remove(entry:SearchEntry, save:Bool = true) -> Int {
        let context = AppDelegate.instance.persistentContainer.viewContext
    ...
    static func getAllSearchEntries() -> [SearchEntry] {
